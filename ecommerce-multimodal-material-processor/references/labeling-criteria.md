...
|--------|----------|----------|--------|----------|
| `celebrity_wear` | 明星穿搭 | Celebrity Outfit | P0 | 2-5% |
| `outfit_core` | 穿搭精选(核心) | Outfit - Core | P0 | 25-35% |
| `outfit_secondary` | 穿搭精选(次要) | Outfit - Regular | P1 | 5-10% |
...
### 1. 明星穿搭 (Celebrity Outfit)

**定义**: 
画面中包含**知名人物**(明星、KOL、代言人),以其**穿搭造型**为主体,展示整体服饰搭配效果。
...
### 2. 穿搭精选(核心) (Outfit - Core)

**定义**: 
**主推产品**的全身穿搭种草图,头部+躯干+脚部均可见,突出整体搭配与风格,用于展示穿搭效果。
...
- "非主推款的旧产品" → outfit_secondary 或 other
```
...
### 3. 穿搭精选(次要) (Outfit - Regular)

**定义**: 
**非核心款**产品的半身穿搭图,头部+躯干可见、脚部不可见,特征与核心款类似,但属于**常规补充款、基础款或过季款**。
...
**判定难点**:
- 需要业务知识区分核心款vs常规款
- **建议**: 如果无法确定,默认归类为 `outfit_secondary`(保守策略)
...
- **人仅作为背景/比例参考** → 归为产品对应的类(`outfit_core`等)
